var girlWood = $("#girl-large"),
girlWoodHeight = girlWood.outerHeight(),
girlWoodOffset = girlWood.offset();
var girlWoodTween = new TimelineMax({paused:true});
girlWoodTween.append( TweenMax.staggerTo(girlWood, 1, {css:{"background-position-x":"25%"}}, 0.05) );

var stairs = $("#stairs"),
stairsHeight = stairs.outerHeight(),
stairsOffset = stairs.offset();
var stairsTween = new TimelineMax({paused:true});
stairsTween.append( TweenMax.staggerTo(stairs, 1, {css:{"transform":"translate3d(0px, 15%, 0px)"}}, 0.05) );
...
dudeOnPhoneTween.append( TweenMax.staggerTo(dudeOnPhone, 1, {css:{"transform":"translate3d(300px, 0px, 0px)"}}, 0.05) );
...
// dogWindowsTween.append( TweenMax.staggerTo(dogWindows, 1, {css:{"transform":"translate3d(-15%, 0px, 0px)"}}, 0.05) );
...
$(window).scroll(function()
{
	...
	scrollTween((dudeOnPhoneOffset.top + dudeOnPhoneHeight) *2.2, dudeOnPhoneHeight, dudeOnPhoneTween, 'vertical');
	scrollTween((stairsOffset.top + stairsHeight) *2.2, stairsHeight, stairsTween, 'vertical');
	scrollTween((girlWoodOffset.top + girlWoodHeight) *2.2, girlWoodHeight, girlWoodTween, 'vertical');
