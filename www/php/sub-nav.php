...
<div id="member-header" class="member-header clearfix">
    <div id="member-button" class="menu-button one-page active">
        <div>☰</div>
        <span id="member-title" class="page-title all-members">Heard City</span>
    </div>
    <nav>
        <ul id="member-fixed" data-breakpoint="600" class="flexnav with-js opacity sm-screen flexnav-hide one-page side-bar-closed">
